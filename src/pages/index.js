        ...
        <div className={styles.container}>
          <div className={styles.section}>
            ...
            <div>
              ...
              <p>
                But what if we're stuck in reality?<br />Today more than ever, we are aware that sometimes we need to <span><Link to="https://www.instagram.com/p/CZRVKKIMhqL/" target="_blank" rel="noreferrer">#reload</Link></span>, <span><Link to="https://www.instagram.com/p/CZzp1QzFmD5/" target="_blank" rel="noreferrer">#recharge</Link></span> or <span>#refresh</span> our lives, environment, and system. We are stuck between global crises like the pandemic, recession and climate change. But, we are also in control of updating old systems to new realities!
              </p>
              <p>
